...
export function Sidebar({ closed, toggleClosed, children }: SidebarProps) {
  return (
    <div className={`${styles.wrapper} ${closed && styles.closed}`}>
      ...
      <button type="button" className={styles.closeButton} onClick={toggleClosed}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
